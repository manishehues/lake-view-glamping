...
if ( ! class_exists( 'WPHB_Post_Types' ) ) {
	...
	class WPHB_Post_Types {
		...
		public function custom_room_columns( $a ) {
			$a['room_type']           = __( 'Dome Type', 'wp-hotel-booking' );
		...
		public function register_post_types() {
			...
			$args = array(
				'labels'             => array(
					'name'               => _x( 'Domes', 'post type general name', 'wp-hotel-booking' ),
					'singular_name'      => _x( 'Dome', 'post type singular name', 'wp-hotel-booking' ),
					'menu_name'          => __( 'Domes', 'wp-hotel-booking' ),
					'parent_item_colon'  => __( 'Parent Item:', 'wp-hotel-booking' ),
					'all_items'          => __( 'Domes', 'wp-hotel-booking' ),
					'view_item'          => __( 'View Dome', 'wp-hotel-booking' ),
					'add_new_item'       => __( 'Add New Dome', 'wp-hotel-booking' ),
					'add_new'            => __( 'Add New Dome', 'wp-hotel-booking' ),
					'edit_item'          => __( 'Edit Dome', 'wp-hotel-booking' ),
					'update_item'        => __( 'Update Dome', 'wp-hotel-booking' ),
					'search_items'       => __( 'Search Dome', 'wp-hotel-booking' ),
				...
				'hierarchical'       => false,
				'rewrite'            => array(
					'slug'       => _x( 'domes', 'URL slug', 'wp-hotel-booking' ),
					'with_front' => false,
					'feeds'      => true
				),
				// 'can_export'         => false,
		...
		public static function register_taxonomies() {
			...
			$args = array(
				'hierarchical' => true,
				'label'        => __( 'Dome Type', 'wp-hotel-booking' ),
				'labels'       => array(
					'name'              => _x( 'Dome Types', 'taxonomy general name', 'wp-hotel-booking' ),
					'singular_name'     => _x( 'Dome Type', 'taxonomy singular name', 'wp-hotel-booking' ),
					'menu_name'         => _x( 'Dome Types', 'Dome Types', 'wp-hotel-booking' ),
					'search_items'      => __( 'Search Dome Types', 'wp-hotel-booking' ),
					'all_items'         => __( 'All Dome Types', 'wp-hotel-booking' ),
					'parent_item'       => __( 'Parent Dome Type', 'wp-hotel-booking' ),
					'parent_item_colon' => __( 'Parent Dome Type:', 'wp-hotel-booking' ),
					'edit_item'         => __( 'Edit Dome Type', 'wp-hotel-booking' ),
					'update_item'       => __( 'Update Dome Type', 'wp-hotel-booking' ),
					'add_new_item'      => __( 'Add New Dome Type', 'wp-hotel-booking' ),
					'new_item_name'     => __( 'New Dome Type Name', 'wp-hotel-booking' )
				),
				'public'       => true,
				'show_ui'      => true,
				'query_var'    => true,
			...
			$args = array(
				...
				'label'        => __( 'Dome Capacity', 'wp-hotel-booking' ),
				'labels'       => array(
					'name'              => __( 'Dome Capacities', 'wp-hotel-booking' ),
					'singular_name'     => __( 'Dome Capacity', 'wp-hotel-booking' ),
					'menu_name'         => _x( 'Dome Capacities', 'Dome Capacities', 'wp-hotel-booking' ),
					'search_items'      => __( 'Search Dome Capacities', 'wp-hotel-booking' ),
					'all_items'         => __( 'All Dome Capacity', 'wp-hotel-booking' ),
					'parent_item'       => __( 'Parent Dome Capacity', 'wp-hotel-booking' ),
					'parent_item_colon' => __( 'Parent Dome Capacity:', 'wp-hotel-booking' ),
					'edit_item'         => __( 'Edit Dome Capacity', 'wp-hotel-booking' ),
					'update_item'       => __( 'Update Dome Capacity', 'wp-hotel-booking' ),
					'add_new_item'      => __( 'Add New Dome Capacity', 'wp-hotel-booking' ),
					'new_item_name'     => __( 'New Dome Type Capacity', 'wp-hotel-booking' )
				),
				'show_ui'      => true,
				'query_var'    => true,
				'rewrite'      => array(
