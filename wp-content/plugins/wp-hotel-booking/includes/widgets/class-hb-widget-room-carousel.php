<?php
/**
 * WP Hotel Booking widget room carousel.
 *
 * @version       1.9.6
 * @author        ThimPress
...
class HB_Widget_Room_Carousel extends WP_Widget{
    ...
    public function __construct()
    {
        parent::__construct(
            ...
            __( 'HB Domes Carousel', 'wp-hotel-booking' ), // name of widget
            array( 'description' => __( "Display Domes slider", 'wp-hotel-booking' ) ) // description widget
        );
    }
