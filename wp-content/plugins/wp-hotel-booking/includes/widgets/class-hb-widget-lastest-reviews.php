...
class HB_Widget_Lastest_Reviews extends WP_Widget{
    ...
    public function __construct()
    {
        parent::__construct(
            ...
            __( 'HB Domes Lastest Reviews', 'wp-hotel-booking' ), // name of widget
            array( 'description' => __( "Display domes have lastest reviews", 'wp-hotel-booking' ) ) // description widget
        );
    }
