...
if ( ! class_exists( 'WPHB_Admin_Setting_Room' ) ) {
	...
	class WPHB_Admin_Setting_Room extends WPHB_Admin_Setting_Page {
		...
		function __construct() {
			...
			$this->title = __( 'Dome', 'wp-hotel-booking' );
		...
		public function get_settings() {
			return apply_filters( 'hotel_booking_admin_setting_fields_' . $this->id, array(
					...
					array(
							'type'		=> 'section_start',
							'id'		=> 'room_setting',
							'title'		=> __( 'Dome Options', 'wp-hotel-booking' ),
							'desc'		=> __( 'Dome settings display column number and image size used in gallery single page', 'wp-hotel-booking' )
						),
					...
					array(
							...
							'title'		=> __( 'Dome images size gallery', 'wp-hotel-booking' )
						),
					...
					array(
							...
							'title'		=> __( 'Dome images thumbnail', 'wp-hotel-booking' )
						),
