...
if ( ! class_exists( 'HB_Extra_Post_Type' ) ) {
	...
	class HB_Extra_Post_Type {
		...
		public function init() {
			$labels = array(
				'name'               => __( 'Extra Dome', 'wp-hotel-booking' ),
				'singular_name'      => __( 'Extra Dome', 'wp-hotel-booking' ),
				'add_new'            => _x( 'Add New Extra Dome', 'wp-hotel-booking', 'wp-hotel-booking' ),
				'add_new_item'       => __( 'Add New Extra Dome', 'wp-hotel-booking' ),
				'edit_item'          => __( 'Edit Extra Dome', 'wp-hotel-booking' ),
				'new_item'           => __( 'New Extra Dome', 'wp-hotel-booking' ),
				'view_item'          => __( 'View Extra Dome', 'wp-hotel-booking' ),
				'search_items'       => __( 'Search Extra Dome', 'wp-hotel-booking' ),
				'not_found'          => __( 'No Extra Dome found', 'wp-hotel-booking' ),
				'not_found_in_trash' => __( 'No Extra Dome found in Trash', 'wp-hotel-booking' ),
				'parent_item_colon'  => __( 'Parent Singular Extra Dome:', 'wp-hotel-booking' ),
