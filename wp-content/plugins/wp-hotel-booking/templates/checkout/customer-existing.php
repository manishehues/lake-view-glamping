        ...
        <div class="hb-col-padding hb-col-border">
            ...
            <ul class="hb-form-table">
                <li class="hb-form-field">
                    <label class="hb-form-field-label"><?php _e( 'Email Address', 'wp-hotel-booking' ); ?></label>
                ...
                <li>
                    <button class="btn btn-primary" type="button" id="fetch-customer-info"><?php _e( 'Apply', 'wp-hotel-booking' ); ?></button>
                </li>
            </ul>
        </div>
    </div>
