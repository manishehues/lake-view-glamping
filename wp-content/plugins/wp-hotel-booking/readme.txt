=== WP Hotel Booking ===
Contributors: thimpress, leehld, phamtungpth, thoakim, manhnl311
...
WP Hotel Booking is the best free WordPress Plugin for you to build a Hotel or Resort website. This plugin can be used for a hotel, hostel, resort, homestay or any other accommodation services with an excellent online reservation system. 

Having WP Hotel Booking, your hotel website will run better with the powerful add-ons readily available. You can easily manage your hotel website better with the Statistic booking add-on, Booking in single room, Block booking, Authorize.Net Payment method, Stripe Payment method,... 

It has never been easier for you to build your own hotel website to boost your business and your brand on the internet. Without coding knowledge, WP Hotel Booking will bring your hotel/accommodation information to users and bring revenue to your hotel/accommodation.

If you still get confused about how to build your dream hotel booking website, we recommend you to use our Premium Hotel Booking WordPress Themes. Everything is ready for you to use, just import your data with 1 click and wait for the magic to happen.

> Our Premium Hotel Booking WordPress Themes using WP Hotel Booking:
> <a href="https://1.envato.market/G5Rkk?utm_source=WPORG&utm_medium=Hotel&utm_campaign=Content" target="_blank">Sailing | Hotel Booking WordPress Theme</a>, used by +10.000 hotels - $54 only.
> <a href="https://1.envato.market/VW2K3?utm_source=WPORG&utm_medium=Hotel&utm_campaign=Content" target="_blank">LuxStay | Hotel & BnB WordPress Theme</a> with 100% WooCommerce compatible - $54 only.

<a href="https://hotel.thimpress.com?utm_source=WPORG&utm_medium=Hotel&utm_campaign=Content" target="_blank">Live Demo</a> | <a href="https://docspress.thimpress.com/wp-hotel-booking?utm_source=WPORG&utm_medium=Hotel&utm_campaign=Content" target="_blank">Documentation</a>
...
- <a href="https://wordpress.org/plugins/wp-hotel-booking-wpml-support/" target="_blank">WPML for WP Hotel Booking</a> – Multi-language CMS support for WP Hotel Booking Plugin.
...
+ Fixed the conflict issue which causes Content duplication when Yoast SEO On.
...
+ Update tool check override templates to check WP Hotel Booking add-ons
...
* Remove admin setting light-box tab
...
= 1.8.1 =
* Fix duplicate image in room gallery light-box
...
= 1.7.6.7 =
- Update date-picker with RTL languages
...
* Update latest reviews short-code
* Update best reviews short-code
