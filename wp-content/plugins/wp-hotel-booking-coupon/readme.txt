...
Tags: hotel, booking, hotel booking, reservation, reservations, coupon, discount
...
WP Hotel Booking Coupon supports coupon for WP Hotel Booking plugin.
...
2. Search for 'WP Hotel Booking Coupon'.
3. Activate WP Hotel Booking Coupon from your Plugins page.

**From WordPress.org**
1. Search, select and download WP Hotel Booking Coupon.
...
= 1.7.3 =
+ Fixed bug not correct when checking validation coupon with min and max value.

= 1.7.2 =
+ Improve structure

= 1.7.1 =
+ Publish WP Hotel Booking Coupon to Wordpress
