...
Tags: hotel, booking, hotel booking, reservation, reservations, block booking
...
WP Hotel Booking Block Room Plugin - Support block booking rooms for specific dates for WP Hotel Booking plugin.

== Description ==

**WP Hotel Booking** is a <a href="https://wordpress.org/plugins/wp-hotel-booking/">WordPress Hotel Booking Plugin</a> by ThimPress.

WP Hotel Booking Block Room supports block booking rooms for specific dates for WP Hotel Booking plugin.
...
2. Search for 'WP Hotel Booking Block Room'.
3. Activate WP Hotel Booking Block Room from your Plugins page.

**From WordPress.org**
1. Search, select and download WP Hotel Booking Block Room.
...
= 1.7.7 =
+ Fixed bug can not unblock the chosen date.
+ Made the rooms-select box larger.

= 1.7.6 =
+ Fixed bug missing tables where clicking Update button.
...
= 1.7.1 =
+ Publish WP Hotel Booking Block Room to Wordpress
